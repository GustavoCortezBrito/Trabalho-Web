...
const Produto = ({props, handleClick}) => {
    return(
        <div className="border-2 border-solid border-black rounded-3xl w-56 text-center cursor-pointer">
            ...
            <button
            type="button"
            className=" p-2 my-2 rounded-2xl bg-amber-300 hover:bg-amber-400 active:bg-amber-500"
