...
function Editar() {
    return(
        ...
        <h1 className="mt-20 text-lg md:text-2xl mb-2 font-bold">Atualização de Cadastro de Usuario</h1>
        <div className="border-2 rounded-2xl shadow-lg border-black border-solid  mb-10 p-2">
            <form className="flex flex-col items-center my-3">
                ...
                <div class="flex space-x-2 justify-center mt-3">
                    <Link to=''><button onClick={() => { alert("Editado com sucesso")}} type="button" class="inline-block px-6 py-2.5 font-medium text-xs leading-tight uppercase rounded shadow-md  hover:text- hover:shadow-lg border-2 border-black hover:bg-gray-200">Editar</button></Link>
                </div>
                </div>
            </form>
        </div>
